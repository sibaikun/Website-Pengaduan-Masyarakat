...
<body class="bg-gray-100">
    <!-- Wrapper utama dengan min-h-screen dan flex -->
    <div class="min-h-screen flex flex-col">
        ...
        <!-- Main Content - flex-grow membuat ini mengisi ruang kosong -->
                        ...
                        <div class="p-6 space-y-4">
                            ...
                            @empty
                                <div class="text-center py-12">
                                    ...
                                    <p class="text-gray-500 text-lg">Belum ada pengaduan terbaru.</p>
                                </div>
                            @endforelse
                        </div>
                    </div>
