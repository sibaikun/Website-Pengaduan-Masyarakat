        ...
        <section class="bg-red-500 text-white py-12">
            <div class="container mx-auto px-4 text-center">
                ...
                <div class="flex flex-col md:flex-row justify-center space-y-4 md:space-y-0 md:space-x-4">
                    <a href="/complaints/public" class="bg-yellow-500 text-black px-6 py-3 rounded-lg font-semibold hover:bg-yellow-400 transition-colors inline-flex items-center justify-center">
                        <i class="fas fa-eye mr-2"></i>Lihat Pengaduan
                    </a>
                    <a href="{{ route('login') }}" class="bg-red-600 px-6 py-3 rounded-lg font-semibold hover:bg-red-700 transition-colors inline-flex items-center justify-center">
